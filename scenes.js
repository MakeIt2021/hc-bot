    ...
    GenWhyWaterScene() {
        ...
        whyWater.enter(async ctx => {
            ...
            await ctx.reply('Все знают, что без воды жить нельзя. А для чего конкретно нужна вода?\n' +
                ...
                '\n' +
                'Вода помогает пищеварительной системе лучше усваивать пищу, участвует в терморегуляции, помогая поддерживать нормальную температуру тела, обеспечивает свободное кровообращение, снижает вязкость крови, помогает снабжать кислородом все органы и ткани организма. С помощью воды из организма выводятся ненужные соли и токсины, улучшается подвижность суставов, т.к. составной частью синовиальной жидкости, обеспечивающей её, является вода. \n' +
                '\n' +
                'Именно благодаря соблюдению питьевого режима воды в организме будет достаточно для выполнения всех её функций.', {
                reply_markup: {
                    inline_keyboard: [
                        [
                            {text: 'Назад в меню', callback_data: 'back'}
