...
class SceneGenerator {
    ...
    GenMainMenuScene () {
        ...
        mainMenu.enter(async (ctx) => {
            ...
            await ctx.reply(`В последнем обновлении должна была быть исправлена проблема с перемешиванием данных пользователей или забыванием пользователей. Пожалуйста, свяжитесь с @MakeItApps, если заметите, что эта проблема появится вновь. Основное меню:`, {
                reply_markup: {
                    inline_keyboard: [
                        [
