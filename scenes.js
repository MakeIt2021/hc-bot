        ...
        meals.enter(async (ctx) => {
            ...
            if (await user) {
                ...
                if (bmi < 18.5) {
                    ...
                    result = `Мы посчитали Ваш ИМТ по предоставленным Вами данным, он примерно равен ${bmi}. Это может указывать на недостаток веса. Задайте себе вопрос, часто ли бывает, что Вы чувствуете себя уставшим? \n` +
                        '\n' +
...
Мы посчитали, что Вам рекомендуется употреблять ~${calories} калорий в сутки для поддержания Вашего веса.` +
                    ...
                    result = `Мы посчитали Ваш ИМТ по предоставленным Вами данным, он примерно равен ${bmi}. Это может указывать на наличие избыточной массы тела, предожирение. Это ещё не болезнь, но уже сигнал на то, что следует взять свой вес под контроль.\n` +
                        '\n' +
